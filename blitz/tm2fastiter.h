...
namespace blitz
{
  ...
  public:
    ...
    */
    ...
    {
      return data_[offset1 * T_matrix::stride(dim1) + offset2 * T_matrix::stride(dim2)];
    }
                     ...
                     prettyPrintFormat &format) const
    {
      ...
      else
      {
        ...
        str += tmpBuf;
        str += ",";
        snprintf(tmpBuf, TEMP_SIZE_BUFFER, "%d", N_columns);
  ...
  template <typename P_numtype, int N_rows, int N_columns>
  class FastTM2Iterator : public FastTM2IteratorBase<P_numtype, N_rows, N_columns,
  ...
  template <typename P_numtype, int N_rows, int N_columns>
  class FastTM2CopyIterator : public FastTM2IteratorBase<P_numtype, N_rows, N_columns, const TinyMatrix<P_numtype, N_rows, N_columns>>
  {
  public:
    typedef FastTM2IteratorBase<P_numtype, N_rows, N_columns,
                                const TinyMatrix<P_numtype, N_rows, N_columns>>
