...
namespace blitz
{
  ...
  public:
    ...
    {
      BZPRECONDITION(r == 0);
      return stride == stride_;
    }

    void push(int position)
    {
      BZPRECONDITION(position == 0);
    ...
    */
                     ...
                     prettyPrintFormat &format) const
    {
      ...
      else
      {
        ...
        snprintf(tmpBuf, TEMP_SIZE_BUFFER, "%d", N_length);
  ...
  template <typename P_numtype, int N_length>
  class FastTV2Iterator : public FastTV2IteratorBase<P_numtype, N_length, const TinyVector<P_numtype, N_length> &>
  {
  public:
    typedef FastTV2IteratorBase<P_numtype, N_length,
                                const TinyVector<P_numtype, N_length> &>
        T_base;
  ...
  template <typename P_numtype, int N_length>
  class FastTV2CopyIterator : public FastTV2IteratorBase<P_numtype, N_length, const TinyVector<P_numtype, N_length>>
  {
  public:
    typedef FastTV2IteratorBase<P_numtype, N_length,
                                const TinyVector<P_numtype, N_length>>
