...
void fortran90Version(loop &lp)
{
	...
	char filename[128];
	sprintf(filename, "%sf90.f90", lp.loopName());
	ofstream ofs(filename);
...
void cppVersion(loop &lp)
{
	...
	ofs << "// Generated code (makeloops.cpp) -- do not edit." << endl
		<< endl
		<< "// In KAI C++ 3.2, restrict causes problems for copy propagation."
		<< endl
		<< "// Temporary fix: disable restrict" << endl
		<< endl
		<< "#define BZ_DISABLE_RESTRICT" << endl
		<< endl
		...
		<< "#ifdef BZ_HAVE_VALARRAY\n"
		   ...
		   " #define "
		<< lp.loopName() << "_f77 " << lp.loopName() << "_f77_\n"
														" #define "
		<< lp.loopName() << "_f77overhead " << lp.loopName() << "_f77overhead_\n"

																" #define "
		<< lp.loopName() << "_f90 " << lp.loopName() << "_f90_\n"
														" #define "
		<< lp.loopName() << "_f90overhead " << lp.loopName() << "_f90overhead_\n"

																"#elif defined(BZ_FORTRAN_SYMBOLS_WITH_DOUBLE_TRAILING_UNDERSCORES)\n"
																" #define "
		<< lp.loopName() << "_f77 " << lp.loopName() << "_f77__\n"
														" #define "
		<< lp.loopName() << "_f77overhead " << lp.loopName() << "_f77overhead__\n"

																" #define "
		<< lp.loopName() << "_f90 " << lp.loopName() << "_f90__\n"
														" #define "
		<< lp.loopName() << "_f90overhead " << lp.loopName() << "_f90overhead__\n"

																"#elif defined(BZ_FORTRAN_SYMBOLS_CAPS)\n"
																" #define "
		<< lp.loopName() << "_f77 " << capsLoopName << "_F77\n"
													   " #define "
		<< lp.loopName() << "_f77overhead " << capsLoopName << "_F77OVERHEAD\n"
															   " #define "
		<< lp.loopName() << "_f90 " << capsLoopName << "_F90\n"
													   " #define "
		<< lp.loopName() << "_f90overhead " << capsLoopName << "_F90OVERHEAD\n"
															   "#endif\n"
															   "\n"
															   "extern \"C\" {"
		<< endl;
